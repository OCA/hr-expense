...
class TestHrExpensePaymentWidgetAmount(TransactionCase):
    ...
    def test_expense_sheet_employee(self):
        ...
        self.assertTrue(self.expense_sheet.expense_payments_widget)

    def test_expense_sheet_employee_currency(self):
        """
        ...
        self.assertEqual(
            content_payment_widget[0]["amount"],
            self.expense_sheet_currency.total_amount,
        )

    def test_expense_sheet_company(self):
