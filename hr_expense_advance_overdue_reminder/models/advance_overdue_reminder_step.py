...
class AdvanceOverdueReminderStep(models.Model):
    ...
    partner_id = fields.Many2one(readonly=True, states={"draft": [("readonly", False)]})
    reminder_type = fields.Selection(
        readonly=True, states={"draft": [("readonly", False)]}
    )
    mail_subject = fields.Char(readonly=True, states={"draft": [("readonly", False)]})
    mail_body = fields.Html(readonly=True, states={"draft": [("readonly", False)]})
    ...
    def _create_mail_template(self, vals):
        ...
        self.write({"mail_subject": mail_subject, "mail_body": mail_body})
        return self
