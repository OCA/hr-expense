...
class HrExpenseSheet(models.Model):
    ...
    def _compute_overdue(self):
        ...
        for sheet in self:
            ...
            if (
                ...
                if not sheet.reminder_next_time:
                    sheet.is_overdue = True
                # Check if the sheet has a reminder and it is overdue
                elif sheet.reminder_next_time < date:
                    sheet.is_overdue = True
    ...
    def _compute_overdue_reminder(self):
        for sheet in self:
            ...
            sheet.overdue_reminder_counter = len(reminder) if reminder else 0
