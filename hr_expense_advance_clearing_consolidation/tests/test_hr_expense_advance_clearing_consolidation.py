...
class TestHrExpenseAdvanceClearingConsolidation(common.SavepointCase):
    ...
    def test_1_consolidate_open_advances(self):
        ...
        self._register_payment(self.advance1.account_move_id)
        ...
        self._register_payment(self.advance2.account_move_id)
        ...
        self._register_payment(self.advance3.account_move_id)
